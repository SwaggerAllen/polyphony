defmodule PolyphonyWeb.Transcript do
  ...
  **Nothing here decides who sees what.** `Polyphony.Core.Visibility` already did that
  ...
  Display only — `Polyphony.Core.Visibility` already decided who sees what before the
