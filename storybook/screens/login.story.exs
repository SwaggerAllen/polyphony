  ...
  def variations do
    [
      ...
      %Variation{
        ...
        attributes: %{id: "sent", sent_to: "wren@example.com"}
      },
      %Variation{
        id: :sent_to_nobody,
        description:
        ...
        attributes: %{id: "nobody", sent_to: "nobody@example.com"}
      },
      %Variation{
        id: :dev_link_exposed,
        description:
        ...
        attributes: %{
          id: "dev",
          sent_to: "wren@example.com",
          dev_link: "/auth/verify/example-token"
        }
      },
      %Variation{
        id: :signed_in,
        ...
        attributes: %{id: "signed-in", current_user: %{id: "u1", username: "wren", role: "user"}}
      }
    ]
  end
end
